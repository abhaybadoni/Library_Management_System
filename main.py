...
import sqlite3
import addbook,addmember,givebook,returnbook,deletebook
...
class Main(object):
      def __init__(self,master):
        ...
        mainFrame.pack()
        #top frame
        topFrame=Frame(mainFrame,width=1350,height=70,bg='#f8f8f8',padx=20,relief=RIDGE,borderwidth=2)
        topFrame.pack(side=TOP,fill=X)
        #center frame
        centerFrame=Frame(mainFrame,width=1350,bg='#e0f0f0',relief=SUNKEN,height=680)
        centerFrame.pack(side=TOP)
        #center Left Frame
        centerLeftFrame=Frame(centerFrame,width=900,height=700,bg='#e0f0f0',relief=SUNKEN,borderwidth=2)
        centerLeftFrame.pack(side=LEFT)
        #center Right Frame
        centerRightFrame=Frame(centerFrame,width=450,height=700,bg='#e0f0f0',relief=SUNKEN,borderwidth=2)
        ...
        self.iconsearch=PhotoImage(file='search.png')
        self.btn_search=Button(search_bar,image=self.iconsearch,command=self.searchBooks)
        ...
        btn_list=Button(list_bar,text='List Books',bg='#2488ff',fg='white',font='arial 22',command=self.listBooks)
        ...
        self.img_library=PhotoImage(file='library.png')
        self.lblImg=Label(image_bar,image=self.img_library)
        self.lblImg.grid(row=1)
##################################################################Tool Bar########################################################
        #Buttons
        #add book
        self.iconbook=PhotoImage(file='addbook.png')
        ...
        #add member
        self.iconmember=PhotoImage(file='addmember.png')
        ...
        #give Book
        self.icongive=PhotoImage(file='givebook.png')
        ...
        self.btnbook.pack(side=LEFT)
        #del book 
        self.icondel=PhotoImage(file='deletebook.png')
        self.btndel=Button(topFrame,text="DELETE BOOKS",image=self.icondel,compound=LEFT,font='aerial 12 bold',padx=10,command=self.delBook)
...
#################################################Tabs########################################
     ################################Tab1#######################################
        ...
        self.tab2_icon=PhotoImage(file='member.png')
...
################################Frames##############################
    ...
    self.lbl_member=Label(self.bottomFrame,text='Member Name:',font='arial 15 bold',fg='white',bg='#fcc324')
    self.lbl_member.place(x=40,y=80)
    self.combo_member=ttk.Combobox(self.bottomFrame,textvariable=self.member_name,width=50)
...
def main():
    root=Tk()
    app=Main(root)
    root.title("Library Management System ".upper())
